    ...
    def receiveMessage(self, currentTime, msg):
        ...
        if self.state == 'AWAITING_SPREAD':
            ...
            if msg.body['msg'] == 'QUERY_SPREAD':
                ...
                if self.impact:
                    print("Impact agent firing: {} {} @ {} @ {}".format('BUY' if direction else 'SELL', shares,
                                                                        self.dollarize(price), currentTime))
                    self.placeLimitOrder(self.symbol, shares, direction, price)
                else:
                    print("Impact agent would fire: {} {} @ {} (but self.impact = False)".format(
                        'BUY' if direction else 'SELL', shares, self.dollarize(price)))
