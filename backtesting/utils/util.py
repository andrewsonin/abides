...
from typing import Type, Generator, Union, Iterable, List, Any, overload

import numpy as np
import pandas as pd
from scipy.spatial.distance import pdist, squareform

from backtesting.globals import silent_mode
...
is_integer_type = partial(np.issubdtype, arg2=np.integer)
...
def is_integer(value: Any) -> bool:
    ...
    Returns:
        result of the check
    """
    return is_integer_type(type(value))
